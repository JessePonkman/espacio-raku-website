...
- Optional screenshot frame
- Optional accessible carousel
- Source/name attribution

## Content/data model

- Quote or screenshot reference
- Display name/privacy mode
- Source label
- Alt text/transcription for screenshots
- Display order
...
- 3–5 approved screenshots or source review text
