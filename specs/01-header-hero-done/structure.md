...
- Responsive image/overlay treatment

## Content/data model

- Logo asset and accessible label
- Hero title/subtitle
- CTA label and WhatsApp message key
- Hero image and focal-point metadata
...
- Approved high-resolution hero image
- Current logo asset in web-ready format
