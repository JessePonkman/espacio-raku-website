...
- Optional privacy/external-content notice

## Content/data model

- Google Calendar embed URL
- Calendar title/help copy
- Fallback state
- WhatsApp availability message
- External iCal feed inventory (operational, not exposed publicly)
...
- No image required; optional branded placeholder illustration
